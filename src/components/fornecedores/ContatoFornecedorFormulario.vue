<template>
  <q-form ref="formRef" class="contato-fornecedor-formulario" greedy>
    <q-input
...
import type { ContatoFornecedorFormModel } from 'types/dtos/fornecedor.dto';
import { email, obrigatorio, telefone } from 'utils/validators';
import { computed, ref } from 'vue';

const formulario = defineModel<ContatoFornecedorFormModel>('formulario', { required: true });
