<template>
  <q-page class="agro-page">
    <app-page-header
      titulo="OEE / Eficiência produtiva"
      subtitulo="Disponibilidade, performance e qualidade."
    />

    <section class="agro-section">
      <agro-card>
        <div class="agro-filter-bar">
          <q-input v-model.number="mes" outlined dense type="number" label="Mês" class="filtro" min="1" max="12" />
          <q-input v-model.number="ano" outlined dense type="number" label="Ano" class="filtro" min="2020" />
          <agro-btn
            color="primary"
            unelevated
            label="Atualizar"
            descricao="Carregar OEE"
            :loading="carregando"
...
const { oee, carregando, carregar } = useOee();
